...
The table is created by the Alembic migrations (`alembic upgrade head`); the `campaign_runs`
definition below is what the queries use and what a new migration is autogenerated against.
"""
