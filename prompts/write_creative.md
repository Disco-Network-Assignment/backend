...
Before you finalise, call check_creative with your draft. It applies the length limits, the ban on unstated claims, and this persona's dislikes, and returns 'ok' or a list of problems. Fix every problem and check again; only finalise a draft that came back 'ok'.
